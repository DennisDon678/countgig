...
<head>
    ...
    <meta
        content="{{ env('APP_NAME') }}- Buy Airtime and Data for all Network. Make payment for DSTV, GOTV, PHCN other services"
        name="descriptison">
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <header class="site-header-one stricky site-header-one__fixed-top">
            <div class="container-fluid">
                <div class="site-header-one__logo">
                    <a href="/">
                        <h4 class="text-uppercase bold text-white" style="color:white; font-weight:bold;">
                            <spanv style="color:orange;">{{ strtoupper(env('APP_NAME')) }}</spanv>
                        </h4>
                        <!-- <img src="/static/chronic/assets/images/logo-1-1.png" width="136" alt=""> -->
                    </a>
                    <span class="side-menu__toggler" style="margin-left:200px;"><i
                            class="fa fa-bars"></i></span><!-- /.side-menu__toggler -->
                ...
                <div class="main-nav__main-navigation one-page-scroll-menu">
                    <ul class="main-nav__navigation-box">
                        ...
                        <div class="main-nav__right" style="margin-top:10px;">
                            ...
                            <a href="/auth/sign-in" class="thm-btn main-nav__btn "
                                style="background:orange; margin-left:10px;"><span>Login</span></a>
        ...
        <section class="banner-one" id="home">
            ...
            <img src="static/chronic/assets/images/shapes/banner-shape-1-1.png" class="banner-one__bg-shape-1"
                alt="">
            <img src="static/chronic/assets/images/shapes/banner-shape-1-2.png" class="banner-one__bg-shape-2"
                alt="">
            <img src="static/chronic/assets/images/shapes/banner-shape-1-3.png" class="banner-one__bg-shape-3"
                alt="">
            <img src="static/chronic/assets/images/shapes/banner-shape-1-4.png" class="banner-one__bg-shape-4"
                alt="">
            <img src="static/chronic/assets/images/shapes/banner-shape-1-5.png" class="banner-one__bg-shape-5"
                alt="">
                ...
                <div class="row">
                    <div class="col-lg-6 d-flex">
                        <div class="my-auto">
                            <div class="banner-one__content">
                                ...
                                <h4 class="text-white" style="color:white; font-weight:bold;">{{ env('APP_NAME') }}
                                </h4>
                                <p>{{ env('APP_NAME') }} is a registered telecommunication company that provide voice or
                                    data transmission services, such as; Mobile Data, Cable Sub, Electric Bill, Airtime
                                    (VTU).
                                </p>

                                <a href="/auth/sign-in" class="thm-btn banner-one__btn"
                                    style="background:turquoise; margin-left:10px;"><span>Login</span></a>
                    ...
                    <div class="col-lg-6 d-flex justify-content-end wow fadeInUp" data-wow-duration="1500ms">
                        <div class="banner-one__image">
                            <img src="static/chronic/assets/images/resources/tla1.jpg" width="600px"
                                style="border-radius: 300px; border: 30px solid purple;" alt="">
        ...
        <section class="service-one" id="features">
            <div class="container">
                <div class="block-title text-center">
                    <h3>Our Services</h3>
                    <p>We offer instant recharge of Airtime, Databundle, CableTV (DStv, GOtv & Startimes), Electricity
                        Bill Payment, Airtime to cash, Educational pins and more...
                    </p>
                </div><!-- /.block-title -->
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-duration="1500ms"
                        ...
                        <div class="service-one__single">
                            ...
                            <div class="service-one__icon">
                                <img src="static/styles/pheebee/img/feature/wifi.png" alt="" width="60"
                                    class="center">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-duration="1500ms"
                        ...
                        <div class="service-one__single">
                            ...
                            <div class="service-one__icon">
                                <img src="static/styles/pheebee/img/feature/phone.png" alt="" width="60"
                                    class="center">
                            </div><!-- /.service-one__icon -->
                        </div><!-- /.service-one__single -->
                    </div><!-- /.col-lg-3 col-md-6 col-sm-12 -->
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-duration="1500ms"
                        ...
                        <div class="service-one__single">
                            ...
                            <div class="service-one__icon">
                                <img src="static/styles/pheebee/img/feature/tv.png" alt="" width="60"
                                    class="center">
                            </div><!-- /.service-one__icon -->
                        </div><!-- /.service-one__single -->
                    </div><!-- /.col-lg-3 col-md-6 col-sm-12 -->
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-duration="1500ms"
                        ...
                        <div class="service-one__single">
                            ...
                            <p>We offer this service at a very good attractive rate please login to get current
                                conversion rate.
                            </p>
                            <div class="service-one__icon">
                                <img src="static/styles/pheebee/img/feature/airtime.png" alt=""
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-duration="1500ms"
                        ...
                        <div class="service-one__single">
                            ...
                            <p>Because we understand your needs, we have made bills and utilities payment more
                                convenient.
                            </p>
                            <div class="service-one__icon">
                                <img src="static/styles/pheebee/img/feature/light.png" alt="" width="60"
                                    class="center">
                            </div><!-- /.service-one__icon -->
                        </div><!-- /.service-one__single -->
                    </div><!-- /.col-lg-3 col-md-6 col-sm-12 -->
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-duration="1500ms"
                        ...
                        <div class="service-one__single">
                            ...
                            <div class="service-one__icon">
                                <img src="static/styles/pheebee/img/feature/sms.png" alt="" width="60"
                                    class="center">
                            </div><!-- /.service-one__icon -->
                        </div><!-- /.service-one__single -->
                    </div><!-- /.col-lg-3 col-md-6 col-sm-12 -->
        ...
        <section class="cta-four">
            <img src="static/chronic/assets/images/shapes/cta-4-dot-1-1.png" class="cta-four__bg-shape-1"
                alt="">
            <img src="static/chronic/assets/images/shapes/cta-4-shape-1-1.png" class="cta-four__bg-shape-2"
                alt="">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="cta-four__images">
                            <img src="static/chronic/assets/images/resources/google.png" class="wow fadeInUp"
                                data-wow-duration="1500ms" alt="">
                            <img src="static/chronic/assets/images/resources/app%20store.jpg" class="wow fadeInUp"
                                data-wow-duration="1500ms" alt="">
                            <img src="static/chronic/assets/images/resources/bck1.jpg"
                                style="width: 500px; height: 250px;" class="wow fadeInUp" data-wow-duration="1500ms"
                                alt="">
                    ...
                    <div class="col-lg-6">
                        <div class="cta-four__content">
                            ...
                            <div class="cta-four__text">
                                <p>
                                    {{ env('APP_NAME') }} is Nigeria's best option whenever you think of easy and
                                    instant online mobile recharge.<br> Welcome to Nigerian mobile online virtual topup
                                    Dear customer we deal on all kind of mobile virtual airtime topup recharge
                                    cards, data bundles, TV subscriptions, internet subscriptions, education payment and
                                    electricity bills. Many people have joined and our existing Clients had been
                                    enjoying this platform and ever since our exstence. We warmly
        ...
        <section class="cta-three">
            <img src="static/chronic/assets/images/shapes/cta-3-shape-1-2.png" class="cta-three__bg-shape-1"
                alt="">
            <img src="static/chronic/assets/images/shapes/cta-3-shape-1-1.png" class="cta-three__bg-shape-2"
                alt="">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6 wow fadeInRight" data-wow-duration="1500ms">
                        ...
                        <img src="static/chronic/assets/images/resources/img1.jpg"
                            style="width: 500px; border-radius: 100px;" alt="">
                    </div>
                </div><!-- /.col-lg-6 -->
            </div><!-- /.row -->
        </section>
    ...
    <section class="cta-two">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img src="static/chronic/assets/images/resources/cover.png" class="cta-two__content-image"
                        alt="">
                </div><!-- /.col-lg-6 -->
                <div class="col-lg-6">
                    <div class="cta-two__content">
                        ...
                        <p>
                            Join our network of outstanding entrepreneurs patnering with {{ env('APP_NAME') }} Bring
                            the {{ env('APP_NAME') }} 'easy-payments' experience closer to your network and earn a
                            commission for every transaction you perform for your customers. <br><br>We
                            offer our Referrers the best referral program incentives to encourage entrepreneurial and
                            managerial skill acquisition; enhance growth and development and general empowerment among
                            our students on campuses of higher learning
                            and youths in diaspora. Finally, to promote technology via the use of ICT tools in our
                            society.
                        </p>
            ...
            <div class="shadow-lg p-3 mb-5 bg-white rounded">
                <div class="text-center">
                    @php
                        ...
                        $plan = App\Models\plan_type_list::where('network_id', '=', $network->network_id)->get();
                    @endphp
                    <img src="https://qstoresng.com//static/styling/img/app-landing/mockup/a.jpg"
                            ...
                            <table class="table table-all table-responsive">
                                ...
                                <tbody>
                                    @foreach ($plan as $plan)
                                        @php
                                            $sme = App\Models\Dataplans::where('plan_id', '=', $plan->id)->get();
                                            $profit = App\Models\Profits::where('plan_type', '=', $plan->id)->first();
                                        @endphp
                                        <tr>
                                            <td colspan="3">
            ...
            <div class="shadow-lg p-3 mb-5 bg-white rounded">
                <div class="text-center">
                    @php
                        ...
                        $plan = App\Models\plan_type_list::where('network_id', '=', $network->network_id)->get();
                    @endphp
                    <img src="https://qstoresng.com//static/styling/img/app-landing/mockup/b.jpg"
                        style="border-radius: 50%;" alt="">
    ...
    <section class="testimonials-one" id="testimonials">
        ...
        <div class="container">
            <img src="static/chronic/assets/images/testimonials/teni.jpg" style="width: 90px;" alt="Awesome Image"
                        ...
                        <div id="testimonials-slider-pager">
                            <div class="testimonials-slider-pager-one">
                                <a href="#" class="pager-item active" data-slide-index="0"><img
                                        src="static/chronic/assets/images/testimonials/teni.jpg"
                                        alt="Awesome Image"></a>
                                <a href="#" class="pager-item" data-slide-index="1"><img
                                        src="static/chronic/assets/images/testimonials/mojeed.jpg"
                                        alt="Awesome Image"></a>
                                <a href="#" class="pager-item" data-slide-index="2"><img
                                        src="static/chronic/assets/images/testimonials/pheebz.jpg"
                                        alt="Awesome Image"></a>
                    ...
                    <ul class="slider testimonials-slider">
                        <li class="slide-item">
                            <div class="testimonials-one__single">
                                <p>I love the quick response to issues. We might just get along well. So far so good. I
                                    recommnd this platform to everyone.
                                </p>
                        ...
                        <li class="slide-item">
                            <div class="testimonials-one__single">
                                <p class="p-lg grey-color">These site is great. {{ env('APP_NAME') }} is best platform
                                    when its come to affordable data plan for both end-user and resseller ,i recommend
                                    this platform it's fast, automated and secured.
                                </p>
                                <h3>Benjamin Josh</h3>
                                <span>WEB DEVELOPER</span>
                            </div><!-- /.testimonials-one__single -->
    ...
    <section class="faq-one">
        <div class="container">
            <div class="block-title text-center">
                ...
                <p>Here at {{ env('APP_NAME') }} our services are completely Fast, Secure & Automated. We provide
                    24/7hrs Support to our registered users</p>
            </div><!-- /.block-title text-center -->
                            ...
                            <div class="accrodion-grp " data-grp-name="faq-accrodion-1">
                                <div class="accrodion active ">
                                    <div class="accrodion-inner">
                                        ...
                                        <div class="accrodion-content">
                                            <div class="inner">
                                                <p>1. Log in to your account <br> 2. If not click here to register <br>
                                                    3. After log in click fund my account <br> 4. Select Coupon payment
                                                    <br> <br> NB:You can buy coupon code from our agents
                                                </p>
                                            </div><!-- /.inner -->
                                        </div>
                                    </div><!-- /.accrodion-inner -->
                                ...
                                <div class="accrodion ">
                                    <div class="accrodion-inner">
                                        ...
                                        <div class="accrodion-content">
                                            <div class="inner">
                                                <p>You can fund your wallet using any of our Four payment means: Bank
                                                    payment.
                                                    <br> Online Payment with your ATM card details via Pay stack Payment
                                                    Gateway.
                                                    <br> Payment with airtime.
                                                    <br> Payment with Coupon Code(s).
                                                </p>
                                            </div><!-- /.inner -->
                                        </div>
                                    </div><!-- /.accrodion-inner -->
                                        ...
                                        <div class="accrodion-content">
                                            <div class="inner">
                                                <p class="p-lg">STEP 1: Fund your wallet. <br>
                                                    ...
                                                    STEP 3: Wait for 1-15 minutes, the recipient will receive
                                                    notification(s) of data recharge(Except for 9mobile(SME), which
                                                    should be confirmed with its balance code)
                                                </p>
                                            </div><!-- /.inner -->
                                        </div>
                                    </div><!-- /.accrodion-inner -->
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6">
                        <div class="footer-widget footer-widget__about">
                            ...
                            <h4 class="text-uppercase bold " style="color:black; font-weight:bold;">
                                <spanv style="color:orange;">{{ strtoupper(env('APP_NAME')) }}</spanv>
                            </h4>

                            <p>Here at {{ env('APP_NAME') }}, we offer you<br> the most affordable and most cheapest
                                data,<br> airtime, Dstv, Gotv and Startimes subscription.
                                <br>
                            </p>
                        ...
                        <div class="footer-widget footer-widget__contact">
                            ...
                            <ul class="footer-widget__contact-list list-unstyled">
                                ...
                                <li>
                                    ...
                                    <a href="mailto:{{ env('APP_NAME') }}@gmail.com">
                                        {{ env('APP_NAME') }}@gmail.com</a>
                                </li>
                                <!-- <li>
        ...
        <div class="site-footer__bottom">
            <div class="container">
                <div class="inner-container">
                    <p>© copyright 2022 by {{ env('APP_NAME') }}<a href="#">DEVELOPED BY : </a> <a
                            href="https://www.linkedin.com/in/dennis-chiemezie-onah-7b3a90280/">{{ strtoupper('Don Codes.(Chiemezie Dennis)') }}</a>
                    </p>
        ...
        <div class="side-menu__block-inner ">
            <div class="side-menu__top justify-content-end">
                ...
                <a href="#" class="side-menu__toggler side-menu__close-btn">
                    ...
                    <h4 class="text-uppercase bold " style="color:black; font-weight:bold;">
                        <spanv style="color:orange;">{{ env('APP_NAME') }}</spanv>
                    </h4>
